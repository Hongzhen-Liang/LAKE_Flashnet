...
if __name__ == '__main__':
    ...
    print (f"Write latency p60: {np.percentile(write_latencies, 60)} us")
    print (f"Write latency p80: {np.percentile(write_latencies, 80)} us")
    print (f"Write latency p85: {np.percentile(write_latencies, 85)} us")
    print (f"Write latency p95: {np.percentile(write_latencies, 95)} us")
    print (f"Write latency p99: {np.percentile(write_latencies, 99)} us")
    print (f"Write latency p99.5: {np.percentile(write_latencies, 99.5)} us")
    print (f"Write latency p99.9: {np.percentile(write_latencies, 99.9)} us")
    #print (f"==============================")
