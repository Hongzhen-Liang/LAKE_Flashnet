...
# For granularity == 1
python3 mlHeaderGen+1.py Trace nvme0n1 mlData/drive0weights weights_header_1ssd 1
if [ $3 -gt 1 ]
   then
      python3 mlHeaderGen+1.py Trace nvme0n1 mlData/drive0weights weights_header_1ssd $3
fi
