...
file_list_w2 = glob.glob(input_folder+ '*' + granularity + '.csv.weight_2.csv')
...
file_list_b2 = glob.glob(input_folder+ '*' + granularity + '.csv.bias_2.csv')
# print(file_list_b1)
...
generate_1d_var_T('weight_2_T_'+drive+'_'+granularity, 'long', digits, None, w2_path)
...
generate_1d_var_T('bias_2_'+drive+'_'+granularity, 'long', digits*2, None, b2_path)
print('#endif')
